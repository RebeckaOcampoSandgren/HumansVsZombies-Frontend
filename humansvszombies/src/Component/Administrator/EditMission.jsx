                    ...
                    <ModalBody>
                        <div className='adminFormContainer'>
                            ...
                            <h6 className='headerEditGameform'>Edit Mission</h6>
                                ...
                                <input type="datetime-local" className='form-control' name='startTime' value={selectedMission.startTime}
                                onChange={updateMissionObject}></input>
                                <label>End time</label>
                                <input type="datetime-local" className='form-control' name='endTime' value={selectedMission.endTime}
                                onChange={updateMissionObject}></input>
                            </form>
                        </div>
                    </ModalBody>
